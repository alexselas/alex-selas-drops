...
const socialIcons: Record<string, { path: string; label: string }> = {
  ...
  soundcloud: { label: 'SoundCloud', path: 'M1.175 12.225c-.05 0-.075-.025-.075-.075l-.1-.75.1-.75c0-.05.025-.075.075-.075s.075.025.075.075l.125.75-.125.75c0 .05-.025.075-.075.075zm.9-.05c-.05 0-.1-.025-.1-.075L1.8 11.4l.175-1.1c0-.05.05-.1.1-.1s.1.05.1.1l.2 1.1-.2.7c0 .05-.05.075-.1.075zm.85 0c-.075 0-.1-.025-.125-.1L2.625 11.4l.175-1.5c0-.075.05-.1.125-.1s.1.025.125.1l.2 1.5-.2.675c-.025.075-.05.1-.125.1zm.85-.025c-.075 0-.125-.05-.125-.1L3.475 11.4l.175-2c0-.075.05-.125.125-.125s.125.05.125.125l.2 2-.2.625c0 .075-.05.125-.125.125zm.875-.025c-.1 0-.15-.05-.15-.125L4.35 11.4l.15-2.4c0-.1.05-.15.15-.15s.15.05.15.15l.175 2.4-.175.6c0 .1-.05.15-.15.15zm.875 0c-.1 0-.15-.075-.15-.15L5.225 11.4l.15-2.725c0-.1.05-.175.15-.175.1 0 .175.075.175.175l.15 2.725-.15.575c0 .1-.075.175-.175.175zm.9-.025c-.1 0-.175-.075-.175-.175l-.125-.55.125-3c0-.1.075-.175.175-.175s.175.075.175.175l.15 3-.15.55c0 .1-.075.175-.175.175zm.85.025c-.1 0-.175-.075-.2-.2L6.95 11.4l.125-3.2c.025-.125.1-.2.2-.2s.2.075.2.2l.15 3.2-.15.525c0 .125-.1.2-.2.2zm.925 0c-.125 0-.2-.075-.2-.2L7.875 11.4l.125-3.3c0-.125.075-.225.2-.225.125 0 .225.1.225.225l.125 3.3-.125.525c0 .125-.1.2-.225.2zm.9.025c-.125 0-.225-.1-.225-.225L8.75 11.4l.125-3.075c0-.15.1-.25.225-.25s.225.1.225.25L9.45 11.4l-.125.5c0 .15-.1.25-.225.25zm6.175-1.05c-.275 0-.55.05-.8.125-.15-1.85-1.725-3.3-3.625-3.3-.5 0-.975.1-1.4.275-.175.075-.225.15-.225.3v6.45c0 .15.1.275.25.3h5.8c1.2 0 2.175-.975 2.175-2.175s-.975-2.175-2.175-2.175z' },
};
