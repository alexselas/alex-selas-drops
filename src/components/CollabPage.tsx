...
function PackRow({ item, expanded, onToggle, currentTrackId, isPlaying, isInCart, onPlay, onAddToCart }: {
  ...
  return (
    <div className="rounded-xl overflow-hidden">
      <div
        className={`flex items-center gap-3 p-3 bg-blue-900/40 border border-blue-700/30 hover:border-blue-400/50 transition-colors cursor-pointer ${expanded ? 'rounded-t-xl border-b-0' : 'rounded-xl'}`}
        onClick={onToggle}
      >
